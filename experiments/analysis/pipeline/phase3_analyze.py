...
from .stat import concentration as CONC
from .stat import gof as GOF
from .stat import longitudinal as LONG
from .stat import streak as STREAK
from .stat import timer_race as TR
from .stat import wilson as WIL
