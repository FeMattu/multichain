...
/* MCHN START -- wPoA/weightengine audit RPCs: the optional height / epoch */
    ...
    { "wpoalistfinalweights", 0 },
    { "weightgetlocalcontribution", 0 },
    { "weightlistcontributions", 0 },
    { "weightgetlocalclusterweight", 0 },
    { "weightlistclusterweights", 0 },
    { "weightgetlocalreturns", 0 },
    { "weightlistreturns", 0 },
    { "weightgetlocalearnings", 0 },
    { "weightlistearnings", 0 },
    { "weightgetlocalbalance", 0 },
    { "weightlistbalances", 0 },
    { "wpoagetnodescore", 1 },
    { "wpoagetnodedelay", 1 },
    { "wpoagetnodeeffectiveweight", 1 },
    { "wpoagetnodefinalweight", 1 },
    { "weightgetnodecontribution", 1 },
    { "weightgetnodeclusterweight", 1 },
    { "weightgetnodereturns", 1 },
    { "weightgetnodeearnings", 1 },
    { "weightgetnodebalance", 1 },
/* MCHN END */
};
