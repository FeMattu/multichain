...
void mc_InitRPCHelpMap26()
{
    ...
    mapHelpStrings.insert(std::make_pair("wpoagetblocksortition",
            ...
            "\n"
            "Weights are read AS OF the audited height's parent, not as of the current tip, so\n"
            "the answer reproduces the weight map the round actually ran on however long after\n"
            "the fact it is asked for.\n"
            "\n"
            "Arguments:\n"
