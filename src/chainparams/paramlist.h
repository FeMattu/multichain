...
static const mc_OneMultichainParam MultichainParamArray[] =
{
    ...
    { "wpoasortitiondelay"                , "wpoa-sortition-delay"        ,
                   MC_PRM_STRING  | MC_PRM_USER | MC_PRM_CLONE  , 32,         0,          0,         0, 0.0, 20014, 0, "-mc-wpoasortitiondelay",
                   "enablewpoamalus","",
                   "wPoA sortition delay scale in seconds (delay = s * score * total_effective_weight). Consensus-critical: must be identical on all nodes. Default 1."},
