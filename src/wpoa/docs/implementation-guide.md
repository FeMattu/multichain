...
> **Lo stato di ciascuna fase non e' ripetuto qui.** Vive in una sola sede:
> [implementation-status.md](implementation-status.md). Questa tabella descrive *cosa*
> aggiunge ogni fase, non se sia fatta.
