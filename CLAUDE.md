...
- Anytime u need to search correlations or links or functions in the graph first query the graph. This is helpful instead of raw scraping the codebased everytime, or for every codebase search. 
